// internal/persistence/repository/mongo/playlist_repository.go
...
// InsertPlaylist insere uma nova playlist no banco.
...
// GetPlaylistByID busca uma playlist pelo seu ID.
...
// GetPlaylistsByUserID lista todas as playlists de um usuário.
